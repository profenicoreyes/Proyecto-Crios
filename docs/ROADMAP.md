...
El preflight Firebase del 21 de agosto de 2026 conservó el snapshot remoto aportado por el operador y lo comparó con `719b7fb05c6f7cb277543e4e50836918b8357b4f` y con la candidata. El remoto acepta solo `presence-change` y omite tres denegaciones explícitas de raíz que Firebase resuelve por defecto; la candidata conserva esas defensas y agrega `game-state-change`. La evidencia, la procedencia y el rollback exacto están en [`FIREBASE_RTDB_RULES_PREFLIGHT_2026-08-21.md`](evidence/FIREBASE_RTDB_RULES_PREFLIGHT_2026-08-21.md). No se publicó ningún cambio.

El push permanece diferido. El preflight externo de solo lectura del 20 de agosto de 2026 confirmó que `origin/main` y GitHub Pages sirven `81e39c5d89633ca6c13d0f732f3e940533f475b6`: 75 commits y 198 archivos por detrás del candidato de ese preflight, `626563afd1c1a88ba1905220abe20ded90774186`. Apps Script respondió `UNSUPPORTED_OPERATION` ante `getLiveRoomGameState`; el snapshot Firebase del 21 de agosto cerró la incertidumbre textual preliminar, pero todavía requiere reconfirmación autenticada inmediatamente antes del despliegue y smoke remoto posterior. Por lo tanto, el próximo push constituye una release acumulada y no un hotfix de sincronización.
